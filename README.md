...
* Configured and tested **Microsoft Entra Connect Sync** and **Microsoft Entra Cloud Sync**
* Implemented identity synchronization between **on-premises Active Directory and Microsoft Entra ID**
* Managed Entra ID users, security groups, dynamic membership rules, and P2 licensing
* Configured **Azure Policy** assignments and compliance controls
* Implemented **Allowed Virtual Machine Size SKU** governance
* Tested Azure VM deployments against policy controls
* Analyzed policy-denied deployments and validated governance enforcement
...
* Established **Point-to-Site (P2S) VPN** connectivity
...
* Configured:
  ...
  * User Accounts
* Applied **Group Policy Objects (GPOs)** for centralized user and security management
...
* Designed and integrated:
  ...
  * Flame Detector
  * Infrared (IR) Sensor
* Supported sensor-based monitoring and automated alerts
...
* Basic Virtualization & Server Management
...
⭐ **Feel free to explore my repositories, projects, and certifications.**
